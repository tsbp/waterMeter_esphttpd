...
HttpdBuiltInUrl builtInUrls[]={
	...
	{"/monthly.tpl", cgiEspFsTemplate, monthlyUsage},
	{"/daily.tpl", cgiEspFsTemplate, dailyUsage},
	{"/cntvalue.tpl", cgiEspFsTemplate, tplCounter},
	//{"/led.cgi", cgiLed, NULL},
	{"/counterValue.cgi", cgiCValue, NULL},
...
//	WriteMem(1, 0, (uint8*)&pulseCntr, 4);
	//ReadMem(1, 0, (uint32*) &pulseCntr, 4);
	ReadMem(1, 0, (uint32*) periodUsage.byte, sizeof(sPERIOD_USEGE));
